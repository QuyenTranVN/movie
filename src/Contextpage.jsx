...
export function MovieProvider({ children }) {
  ...
  const fetchSearch = async (query) => {
    const data = await fetch(
      `https://api.themoviedb.org/3/search/movie?api_key=${APIKEY}&with_origin_country=VN&language=vi-VN&query=${query}&page=1&include_adult=false`,
    )
  ...
  const fetchGenre = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/genre/movie/list?api_key=${APIKEY}&with_origin_country=VN&language=vi-VN`,
    )
  ...
  const fetchUpcoming = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/movie/upcoming?api_key=${APIKEY}&with_origin_country=VN&language=vi-VN&page=${page}`,
    )
